...
<div class="panel panel-warning">
    <div class="panel-heading">                                
        <h3 class="panel-title"><strong>Listado de targetacontrol</strong>
	       	<a href="targetacontro/create" name="btn_nuevo" id="btn_nuevo" class="btn btn-sm btn-success pull-right">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table datatable"><thead>
					...
					<tbody>@foreach ($targetacontrol as $valor)								
								<tr>
								<td>{!! $valor->id !!}</td>
						    <td>{!! $valor->numero !!}</td>
						    <td>{!! $valor->vigenciatc !!}</td>
						    <td>
						<a href="targetacontro/{!! $valor->id !!}" class="btn btn-sm btn-default" >
				    		<span class="glyphicon glyphicon-eye-open"></span>
				    	</a>
				    	</td>
						<td>
						<a href="targetacontro/{!! $valor->id !!}/edit" class="btn btn-sm btn-info" >
				    		<span class="glyphicon glyphicon-pencil"></span>
				    	</a>
				    	</td>
						<td>
					    {!! Form::open(array("url" => "targetacontro/".$valor->id, "method" => "DELETE")) !!}
