...
<div class="panel panel-warning">
    <div class="panel-heading">                                
        <h3 class="panel-title"><strong>Listado de conductores</strong>
	       	<a href="conductor/create" name="btn_nuevo" id="btn_nuevo" class="btn btn-sm btn-success pull-right">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table class="table datatable"><thead>
					...
					<tbody>@foreach ($conductores as $valor)								
								<tr>
					   ...
					   <div style="">
						   ...
						   {!! Form::open(array("url" => "conductor/".$valor->id, "method" => "DELETE")) !!}

						   <a href="conductor/{!! $valor->id !!}" class="btn btn-sm btn-default" >
							   <span class="glyphicon glyphicon-eye-open"></span>
						   </a>
						   <a href="conductor/{!! $valor->id !!}/edit" class="btn btn-sm btn-info" >
