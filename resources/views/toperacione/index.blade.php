...
<div class="panel panel-warning">
    <div class="panel-heading">                                
        <h3 class="panel-title"><strong>Listado de toperaciones</strong>
	       	<a href="toperacione/create" name="btn_nuevo" id="btn_nuevo" class="btn btn-sm btn-success pull-right">
        ...
        <div class="table-responsive">
            <table class="table datatable"><thead>
			    		<tr>
					     <th>Id</th>
						    <th>Numerotageta</th>
						    <th>Vigenciatargeta</th>
						    <th>Detalle</th>
						<th>Editar</th>
					    <th>Eliminar</th>
					 </tr>
					</thead>
					<tbody>@foreach ($toperaciones as $valor)								
								<tr>
								<td>{!! $valor->id !!}</td>
						    <td>{!! $valor->numerotageta !!}</td>
						    <td>{!! $valor->vigenciatargeta !!}</td>
						    <td>
						<a href="toperacione/{!! $valor->id !!}" class="btn btn-sm btn-default" >
				    		<span class="glyphicon glyphicon-eye-open"></span>
				    	</a>
				    	</td>
						<td>
						<a href="toperacione/{!! $valor->id !!}/edit" class="btn btn-sm btn-info" >
				    		<span class="glyphicon glyphicon-pencil"></span>
				    	</a>
				    	</td>
						<td>
					    {!! Form::open(array("url" => "toperacione/".$valor->id, "method" => "DELETE")) !!}
